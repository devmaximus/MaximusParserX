...
namespace MaximusParserX.UI.Controls
{
    ...
    public class ListViewSorter : IDisposable
    {
        ...
        /// <summary>
        /// Handles the ListViews ColumnClick event_.
        /// </summary>
        ...
        protected void SetImage(int column, SortOrder sortorder)
        {
            // Nothing to do
            ...
            {
                if (this.listview.SmallImageList.Images.ContainsKey("blank")) ch.ImageKey = "blank";
            }

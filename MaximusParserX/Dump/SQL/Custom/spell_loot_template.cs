...
{
	public class spell_loot_template : CustomDumpObjectBase
    {
        public const string TableName = "spell_loot_template";
		...
		public spell_loot_template() : base(TableName) 
        {
        }
	}
}

...
{
	public class npc_spellclick_spells : CustomDumpObjectBase
    {
		...
		{
			return string.Format("INSERT IGNORE INTO `" + TableName + "` (`npc_entry`, `spell_id`, `quest_start`, `quest_start_active`, `quest_end`, `cast_flags`{6}) VALUES ('{0}', '{1}', '{2}', '{3}', '{4}', '{5}'{7});", npc_entry.GetValueOrDefault(), spell_id.GetValueOrDefault(), quest_start.GetValueOrDefault(), quest_start_active.GetValueOrDefault(), quest_end.GetValueOrDefault(), cast_flags.GetValueOrDefault(), GetInsertCommandCustomFields(), GetInsertCommandCustomValues());
		}

...
{
	public class disenchant_loot_template : DumpObjectBase
    {
        public const string TableName = "disenchant_loot_template";
		...
		public disenchant_loot_template() : base(TableName) 
        {
        }
	}
}

...
{
	public class areatrigger_involvedrelation : DumpObjectBase
    {
        public const string TableName = "areatrigger_involvedrelation";
		...
		public areatrigger_involvedrelation() : base(TableName) 
        {
        }
	}
}

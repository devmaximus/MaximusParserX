...
{
	public class prospecting_loot_template : DumpObjectBase
    {
        public const string TableName = "prospecting_loot_template";
		...
		public prospecting_loot_template() : base(TableName) 
        {
        }
	}
}

...
{
	public class creature_involvedrelation : DumpObjectBase
    {
        public const string TableName = "creature_involvedrelation";
		...
		public creature_involvedrelation() : base(TableName) 
        {
        }
	}
}

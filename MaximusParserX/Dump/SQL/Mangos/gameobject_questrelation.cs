...
{
	public class gameobject_questrelation : DumpObjectBase
    {
        public const string TableName = "gameobject_questrelation";
		...
		public gameobject_questrelation() : base(TableName) 
        {
        }
	}
}

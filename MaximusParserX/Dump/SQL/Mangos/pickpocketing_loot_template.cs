...
{
	public class pickpocketing_loot_template : DumpObjectBase
    {
        public const string TableName = "pickpocketing_loot_template";
		...
		public pickpocketing_loot_template() : base(TableName) 
        {
        }
	}
}

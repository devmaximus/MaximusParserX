...
{
	public class quest_poi : DumpObjectBase
    {
		...
		{
			return string.Format("INSERT IGNORE INTO `" + TableName + "` (`questid`, `poiid`, `objindex`, `mapid`, `mapareaid`, `floorid`, `unk3`, `unk4`) VALUES ('{0}', '{1}', '{2}', '{3}', '{4}', '{5}', '{6}', '{7}');", questid.GetValueOrDefault(), poiid.GetValueOrDefault(), objindex.GetValueOrDefault(), mapid.GetValueOrDefault(), mapareaid.GetValueOrDefault(), floorid.GetValueOrDefault(), unk3.GetValueOrDefault(), unk4.GetValueOrDefault());
		}

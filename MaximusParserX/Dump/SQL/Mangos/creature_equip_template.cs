...
{
	public class creature_equip_template : DumpObjectBase
    {
		...
		{
			return string.Format("INSERT IGNORE INTO `" + TableName + "` (`entry`, `equipentry1`, `equipentry2`, `equipentry3`) VALUES ('{0}', '{1}', '{2}', '{3}');", entry.GetValueOrDefault(), equipentry1.GetValueOrDefault(), equipentry2.GetValueOrDefault(), equipentry3.GetValueOrDefault());
		}

...
{
	public class gameobject_loot_template : DumpObjectBase
    {
        public const string TableName = "gameobject_loot_template";
		...
		public gameobject_loot_template() : base(TableName) 
        {
        }
	}
}

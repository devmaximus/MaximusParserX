...
namespace MaximusParserX
{
    ...
    public enum SpellCastResultCustom
    {
    ...
    {
        IMMUNITY_EFFECT = 0,                     // public enum SpellEffects
        IMMUNITY_STATE = 1,                     // public enum AuraType
        IMMUNITY_SCHOOL = 2,                     // public enum SpellSchoolMask
        IMMUNITY_DAMAGE = 3,                     // public enum SpellSchoolMask
        IMMUNITY_DISPEL = 4,                     // public enum DispelType
        IMMUNITY_MECHANIC = 5                      // public enum Mechanics
    };
    ...
    [Flags]
    public enum GameObjectDynamicLowFlags : uint
    {
    ...
    [Flags]
    public enum CorpseDynFlags : uint
    {
    ...
    public enum ChatLinkColors : uint
    {

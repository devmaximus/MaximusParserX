...
namespace MaximusParserX
{
    ...
    public enum DifficultyChangeType : uint
    {
        PlayerDifficulty1 = 0,
        SpellDuration = 1,
        WorldState = 2,
    ...
    public enum AchievementFactionFlags
    {
    ...
    public enum AchievementCriteriaCompletionFlags
    {
    ...
    public enum SpawnMask : int
    {
        SPAWNMASK_REGULAR = (1 << Difficulty.REGULAR_DIFFICULTY),// any maps without spawn modes (continents/subway) or in minimal spawnmode
    ...
    public enum ItemLimitCategoryMode
    {
    ...
    public enum UnitNameSummonTitle
    {

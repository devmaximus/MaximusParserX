...
namespace MaximusParserX.Parsing.Parsers
{
    ...
    public class CMSG_QUEST_POI_QUERY_DEF : DefinitionBase
    {
        public override bool Parse()
        {
            ...
            {
                var questId = ReadInt32(i, "questId");
            }
    ...
    public class SMSG_QUESTGIVER_REQUEST_ITEMS_DEF : DefinitionBase
    {
        public override bool Parse()
        {
            ...
            {
                var item = ReadUInt32(i, "item");
                var item_count = ReadUInt32(i, "item_count");
                var displayid = ReadUInt32(i, "displayid");
            }
            ...
            //TODO store "RequestItems", quest_id, req_item_text, emote, 1, emote_delay 
